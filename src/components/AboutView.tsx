      ...
      <div className="bg-slate-900 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex gap-4">
            <button
              onClick={onBookClick}
              className="bg-teal-600 hover:bg-teal-700 text-white font-semibold text-sm px-5 py-3 rounded-lg shadow-sm transition-colors"
            >
              Book an Appointment
            </button>
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 mt-16 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7 space-y-10">
          ...
          <div className="bg-slate-50 border border-slate-100 p-8 rounded-3xl relative overflow-hidden">
            ...
            <span className="text-[10px] font-bold tracking-widest uppercase text-teal-600 bg-teal-50 px-2.5 py-1 rounded-md inline-block mb-4">
              Our Core Philosophy
            </span>
        ...
        <div className="lg:col-span-5 space-y-8">
          ...
          <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 shadow-sm text-center">
            <div className="aspect-[3/4] w-full max-w-[280px] mx-auto rounded-2xl bg-teal-50 border border-teal-100 flex items-center justify-center relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-slate-900/5 hover:bg-slate-900/0 transition-all duration-300 flex items-center justify-center">
                <div className="text-center p-4">
                  <div className="w-20 h-20 bg-teal-600 rounded-full flex items-center justify-center mx-auto text-white shadow-md">
                  ...
                  <p className="text-[11px] text-teal-700 font-semibold uppercase tracking-wider">Board Certified Allergist</p>
            ...
            <div className="space-y-6 relative pl-4 border-l border-slate-100">
              {credentials.education.map((edu, idx) => (
                <div key={idx} className="relative group">
                  {/* Timeline dot */}
                  <div className="absolute -left-[21px] top-1 w-2.5 h-2.5 rounded-full bg-teal-600 ring-4 ring-white group-hover:bg-teal-700 transition-colors" />
                  <div className="text-xs font-bold text-teal-600 tracking-wide">{edu.year}</div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6 relative pl-4 border-l border-slate-100">
              {credentials.appointments.map((appt, idx) => (
                <div key={idx} className="relative group">
                  {/* Timeline dot */}
                  <div className="absolute -left-[21px] top-1 w-2.5 h-2.5 rounded-full bg-indigo-600 ring-4 ring-white group-hover:bg-indigo-700 transition-colors" />
                  <div className="text-xs font-bold text-indigo-600 tracking-wide">{appt.year}</div>
